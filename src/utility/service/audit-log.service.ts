...
export type AuditAction =
  ...
  | 'DEPARTMENT_GOAL_CYCLE_UPDATED'
  | 'DEPARTMENT_GOAL_CREATED'
  | 'DEPARTMENT_GOAL_UPDATED'
  | 'DEPARTMENT_GOAL_DELETED'
  ...
  | 'DEPARTMENT_GOAL_IMPORT_PREVIEWED'
  | 'DEPARTMENT_GOAL_IMPORT_COMMITTED';
